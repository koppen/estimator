...
RSpec.describe Derive::PercentOfTotal do
  ...
  it "calculates a percentage of minimum hours" do
    ...
    expect(derived.min_hours(estimate, :with_derived => true)).to eq(10 * 0.3)
  end

  it "calculates a percentage of maximum hours" do
    derived = Derive::PercentOfTotal.new(30)

    expect(derived.max_hours(estimate, :with_derived => true)).to eq(20 * 0.3)
  end

  it "rounds up" do
    derived = Derive::PercentOfTotal.new(25)

    expect(derived.min_hours(estimate, :with_derived => true)).to eq(3)
  end
end
